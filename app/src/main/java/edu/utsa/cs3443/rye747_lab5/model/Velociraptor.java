...
/**
 * This class represents Velociraptor objects.
 * The Velociraptor class extends the Theropod abstract class.
 * The Velociraptor class maintains the myType attribute for Velociraptor objects
 *
...
public class Velociraptor extends Theropod{
	...
	/**
	 * Constructs Velociraptor class objects with the name and isVeg parameters by calling the super class constructor.
	 *
	...
	/**
	 * Returns the Velociraptor object myType attribute.
	 *
	 * @return the value of the Velociraptor object myType attribute
	 */
	...
	/**
	 * Sets the value of the Velociraptor object myType attribute to the specified value.
	 *
	 * @param newType the value specified for assignment to the Velociraptor object myType attribute
	 */
